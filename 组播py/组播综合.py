...
file_contents = []
file_paths = ["北京联通.txt","山西联通.txt","内蒙古联通.txt","辽宁联通.txt","江苏电信.txt","陕西电信.txt","四川电信.txt","河南联通.txt"]  # 替换为实际的文件路径列表
...
###############################################################################################################################################################################
keywords = ['江苏','四川','河南','山西','辽宁','陕西','陕西影视','西部电影','峨眉电影高清']  # 需要提取的关键字列表
pattern = '|'.join(keywords)  # 创建正则表达式模式，匹配任意一个关键字
#pattern = r"^(.*?),(?!#genre#)(.*?)$" #以分类直接复制
