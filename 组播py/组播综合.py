...
file_contents = []
file_paths = ["北京联通.txt","山西联通.txt","辽宁联通.txt","上海电信.txt","河北联通.txt","江苏电信.txt","山东联通.txt","内蒙古联通.txt","湖南电信.txt","陕西电信.txt","四川电信.txt","河南电信.txt","河南联通.txt"]  # 替换为实际的文件路径列表
...
###############################################################################################################################################################################
keywords = ['湖南','上海','江苏','四川','河南','山西','辽宁','山东','河北','陕西','内蒙古','河南公共','河南乡村','河南民生','河南电视剧','河南都市',]  # 需要提取的关键字列表
pattern = '|'.join(keywords)  # 创建正则表达式模式，匹配任意一个关键字
#pattern = r"^(.*?),(?!#genre#)(.*?)$" #以分类直接复制
