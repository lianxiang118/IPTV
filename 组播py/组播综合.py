...
file_contents = []
file_paths = ["北京联通.txt","山西联通.txt","辽宁联通.txt","吉林电信.txt","江苏电信.txt","天津联通.txt","湖南电信.txt","陕西电信.txt","四川电信.txt","重庆联通.txt","河南电信.txt","河南联通.txt"]  # 替换为实际的文件路径列表
...
###############################################################################################################################################################################
keywords = ['湖南','h', '四川','重庆','河南','陕西','河南公共','河南乡村','北京','河南民生','山西','辽宁','吉林','天津','河南电视剧','河南都市','江苏']  # 需要提取的关键字列表
pattern = '|'.join(keywords)  # 创建正则表达式模式，匹配任意一个关键字
#pattern = r"^(.*?),(?!#genre#)(.*?)$" #以分类直接复制
