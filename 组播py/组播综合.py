...
file_contents = []
file_paths = ["北京联通.txt","山西联通.txt","内蒙古联通.txt","辽宁联通.txt","内蒙古电信.txt","江苏电信.txt","湖南电信.txt","陕西电信.txt","四川电信.txt","河南电信.txt","河南联通.txt"]  # 替换为实际的文件路径列表
...
#从整理好的文本中按类别进行特定关键词提取#############################################################################################
keywords = ['IHOT爱', '北京IPTV', "电视指南", "兵器科技", "世界地理", "文化精品", "风云剧场", "风云音乐", "怀旧剧场", "第一剧场", "女性时尚", "风云足球", "央视台球", "央视高网", 'kk', 'kk', 'kk', 'kk', 'kk', 'kk', 'kk']  # 需要提取的关键字列表
pattern = '|'.join(keywords)  # 创建正则表达式模式，匹配任意一个关键字
#pattern = r"^(.*?),(?!#genre#)(.*?)$" #以分类直接复制
...
###############################################################################################################################################################################
keywords = ['湖南','江苏','四川','河南','山西','辽宁','陕西','陕西影视','西部电影','峨眉电影高清','河南公共','河南卫视4K','河南乡村','河南民生','河南电视剧','河南都市',]  # 需要提取的关键字列表
pattern = '|'.join(keywords)  # 创建正则表达式模式，匹配任意一个关键字
#pattern = r"^(.*?),(?!#genre#)(.*?)$" #以分类直接复制
...
################
keywords = ['内蒙古','爱上4K','鄂尔多斯','包头','巴彦淖尔','乌拉特前旗']  # 需要提取的关键字列表
pattern = '|'.join(keywords)  # 创建正则表达式模式，匹配任意一个关键字
#pattern = r"^(.*?),(?!#genre#)(.*?)$" #以分类直接复制
